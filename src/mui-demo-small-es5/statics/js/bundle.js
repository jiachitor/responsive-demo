 ...
 */
(function($, window) {
	var CLASS_PAGE_LEFT = 'mui-page-left';
	var CLASS_PAGE_CENTER = 'mui-page-center';

	var CLASS_TRANSITIONING = 'mui-transitioning';

	var SELECTOR_NAVBAR = '.mui-navbar';
	var SELECTOR_PAGES = '.mui-pages';
...
(function($, window) {
	...
	Slider.prototype.initEvent = function() {
		...
		slider.addEventListener('slide', function(e) {
			var detail = e.detail;
			detail.slideNumber = detail.slideNumber || 0;
			var number = slider.querySelector('.mui-slider-indicator .number span');
			if (number) {
				number.innerText = (detail.slideNumber + 1);
			}

			var indicators = slider.querySelectorAll('.mui-slider-indicator .indicator');
			for (var i = 0, len = indicators.length; i < len; i++) {
